...
function f5(){
    ret = document.querySelector('.i-5').value 
...
function f7(){
 let num1 = document.querySelector('.i-71')
 let num2 = document.querySelector('.i-72')
 num1 = (+num1.value)**(+num2.value)
 document.querySelector('.out-7').innerHTML = num1 + ' Well done! 25/05/2023 08:52 ;)'
}
...
function f8(){
   ...
   switch (s8){
    ...
    break;
    default:
        document.querySelector('.out-8').innerHTML = 'Bitch select something .!,'
        break; }}
...
function f11(){
    let s100 = document.querySelector('.s-110').value
    document.querySelector('.out-11').innerHTML = s100
}
...
function f14(){
    ...
    if(c == '+'){
        ...
        document.querySelector('.out-14').innerHTML = a/b
    } else {document.querySelector('.out-14').innerHTML = a*b}
...
function f15(){
    ...
    if(c=='&&'){
    document.querySelector('.out-15').innerHTML = (a&&b+' I did it =)')
    } else if(c=='||'){
        document.querySelector('.out-15').innerHTML = (a||b+ ' I did it =)')
        }
}
